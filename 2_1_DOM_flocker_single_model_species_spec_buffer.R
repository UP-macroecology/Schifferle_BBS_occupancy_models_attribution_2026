...
# don't use whole US as study site but presences buffered with 750 km
...
foreach(spec = testspecs,
        ...
        .verbose = TRUE) %dopar% {
          ...
          sink(paste0("out_fl_norm_buffer750_", spec, ".txt")) # write console output here
          ...
          save(out, file = file.path(dir, "data", paste0("out_fl_fm_", spec, "_buffer750.RData")))
