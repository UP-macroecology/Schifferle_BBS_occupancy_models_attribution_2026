...
foreach(spec = testspecs,
        ...
        .verbose = TRUE) %dopar% {
          ...
          sink(paste0("out_cl_lu_p_flocker_", gsub(" ", "_", spec),"_hs.txt")) # write console output here
          sink(type = "message")
          ...
          save(multi_colex_cl_lu_p_prior, file = file.path(dir, "data", paste0(gsub(" ", "_", spec), "_cl_lu_p_Stan_prior.RData")))
