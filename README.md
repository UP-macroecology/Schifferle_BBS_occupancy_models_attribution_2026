...
We focus on the conterminous US and the time period 1995 to 2019. Models are fit for single species using a Bayesian approach.
...
The script *1_4_explore_occ_data.R* contains preliminary code for some exploratory plots of the data.
