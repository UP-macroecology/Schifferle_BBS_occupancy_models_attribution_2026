...
model_file <- "dynoccmod_cl_alt3_quadr_lasso_GoF.txt"
...
foreach(spec = testspecs,
        ...
        .verbose = TRUE) %dopar% {
          ...
          sink(paste0("out_cl_alt3_quadr_lasso_", gsub(" ", "_", spec),"_GoF_inits.txt")) # write console output here
          sink(type = "message")
          ...
          out <- autojags(data = bdata, inits = inits, parameters.to.save = params, 
                          ...
                          n.cores = 3,
                          Rhat.limit = 1.1,
                          max.iter = 30000) # Rushing: 50000, Mingjian: 20000
          
          save(out, file = file.path(dir, "data", paste0(gsub(" ", "_", spec), "_cl_alt3_quadr_lasso_GoF_inits.RData")))
