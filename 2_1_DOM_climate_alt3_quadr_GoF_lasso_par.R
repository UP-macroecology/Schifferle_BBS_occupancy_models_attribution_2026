...
foreach(spec = testspecs,
        ...
        .verbose = TRUE) %dopar% {
          ...
          sink(paste0("out_cl_alt3_quadr_lasso_", gsub(" ", "_", spec),"_GoF.txt")) # write console output here
          sink(type = "message")
          ...
          save(out, file = file.path(dir, "data", paste0(gsub(" ", "_", spec), "_cl_alt3_quadr_lasso_GoF.RData")))
