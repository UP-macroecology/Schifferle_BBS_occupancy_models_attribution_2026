...
# 3) transform to equal area projection
...
# we keep managed pasture and rangeland separate
...
# summarise land use variables for three years before focal period as covariates of initial occupancy: ----
