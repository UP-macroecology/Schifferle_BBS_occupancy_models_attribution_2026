...
# Script:   1_2d_attrici_US_tasskew.sh
# Purpose:  Detrend tasskew from 1994 onward with ATTRICI tool (from tasrange and tasskew tasmin and tasmax are derived later)
# Inputs:   data/Counterfactual_env_data/ISIMIP_GSWP3_W5E5/attrici_detrending/input_files/gswp3-w5e5_ssa_gmt_1994_2019.nc
#           data/Env_data/ISIMIP_GSWP3_W5E5/US_tasskew_1994_2019.nc
#           data/Counterfactual_env_data/ISIMIP_GSWP3_W5E5/attrici_detrending/input_files/US_mask.nc
# Outputs:  data/Counterfactual_env_data/ISIMIP_GSWP3_W5E5/attrici_detrending/output/tasskew_detrended/US_tasskew_detrended_1994_2019.nc
...
exec attrici \
     ...
     --input-file /import/ecoc9z/data-zurell/schifferle/BBS_occupancy_models_2023/data/Counterfactual_env_data/ISIMIP_GSWP3_W5E5/attrici_detrending/input_files/US_tasskew_1994_2019.nc \
     --output-dir /import/ecoc9z/data-zurell/schifferle/BBS_occupancy_models_2023/data/Counterfactual_env_data/ISIMIP_GSWP3_W5E5/attrici_detrending/output/tasskew_detrended \
     --variable tasskew \
...
attrici merge-output /import/ecoc9z/data-zurell/schifferle/BBS_occupancy_models_2023/data/Counterfactual_env_data/ISIMIP_GSWP3_W5E5/attrici_detrending/output/tasskew_detrended/timeseries/tasskew  /import/ecoc9z/data-zurell/schifferle/BBS_occupancy_models_2023/data/Counterfactual_env_data/ISIMIP_GSWP3_W5E5/attrici_detrending/output/tasskew_detrended/US_tasskew_detrended_1994_2019.nc
