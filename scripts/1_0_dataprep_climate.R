...
# folder to store rasters of seasonal variables:
...
# for each year (covariates for colonisation and extinction probability)
# summarising three years before the first year (covariates for initial occupancy)
...
# bioclimatic variables summarising three years before focal period as covariates of initial occupancy: ----
...
# seasonal climate summarising three years before focal period as covariate of initial occupancy: ----
...
# dir.create(file.path("plots", "bioclim_vars_scaled_2000"))
# for(i in 1:19){
...
# # plot overall trends over 25 years in single variables:
# var <- "bio15"
# # files of focal years:
# files <- list.files(bioclim_folder, full.names = TRUE, pattern = paste0("(", paste0(1995:2019, collapse = ")|("), ")"))
# # annual files for focal variable:
