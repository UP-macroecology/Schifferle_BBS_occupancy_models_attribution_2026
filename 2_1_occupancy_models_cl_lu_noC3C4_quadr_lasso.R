...
sink("output_cl_lu_noC3C4_quadr_lasso_House_Finch.txt") # write console output here
...
model_file <- "dynoccmod_cl_lu_noC3C4_quadr_lasso.txt"
...
save(out, file = file.path(cluster_import, "data", paste0(gsub(" ", "_", spec), "_cl_lu_noC3C4_quadr_lasso.RData"))) # 2 GB
